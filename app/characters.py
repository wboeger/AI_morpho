...
def _hook_characters():
    return [
        ...
        },
        {
            ...
            'states_json': [
                {'code': '0', 'name': 'near-perpendicular', 'description': 'Shaft nearly perpendicular to base (<60°)', 'threshold_min': None, 'threshold_max': 60},
                {'code': '1', 'name': 'moderately angled', 'description': 'Shaft at moderate angle to base (60°–100°)', 'threshold_min': 60, 'threshold_max': 100},
                {'code': '2', 'name': 'obtusely angled', 'description': 'Shaft obtusely angled relative to base (100°–140°)', 'threshold_min': 100, 'threshold_max': 140},
                {'code': '3', 'name': 'strongly divergent', 'description': 'Shaft strongly divergent from base (>140°)', 'threshold_min': 140, 'threshold_max': None},
            ],
            'dependencies_json': [],
        },
        {
        ...
        },
        {
            ...
            'states_json': [
                {'code': '0', 'name': 'reduced', 'description': 'Heel barely discernible or absent (<0.08)', 'threshold_min': None, 'threshold_max': 0.08},
                {'code': '1', 'name': 'moderate', 'description': 'Heel clearly present, moderate size (0.08–0.18)', 'threshold_min': 0.08, 'threshold_max': 0.18},
                {'code': '2', 'name': 'prominent', 'description': 'Heel large and conspicuous (>0.18)', 'threshold_min': 0.18, 'threshold_max': None},
            ],
            'dependencies_json': [],
        },
        {
        ...
        },
        {
            ...
            'states_json': [
                {'code': '0', 'name': 'abrupt', 'description': 'Sharp angle at heel-shaft transition (<15°)', 'threshold_min': None, 'threshold_max': 15},
                {'code': '1', 'name': 'moderate', 'description': 'Moderate transition angle (15°–40°)', 'threshold_min': 15, 'threshold_max': 40},
                {'code': '2', 'name': 'gradual', 'description': 'Smooth, gradual transition (>40°)', 'threshold_min': 40, 'threshold_max': None},
            ],
            'dependencies_json': [],
        },
    ]
    ...
    return [
        {
            ...
            'formula': 'arc_length(Point) / arc_length(Shaft)',
            'states_json': [
                {'code': '0', 'name': 'much shorter than shaft', 'description': 'Point much shorter than shaft (<0.45)', 'threshold_min': None, 'threshold_max': 0.45},
                {'code': '1', 'name': 'approximately half the shaft', 'description': 'Point approximately half shaft length (0.45–0.55)', 'threshold_min': 0.45, 'threshold_max': 0.55},
                {'code': '2', 'name': 'shorter than shaft', 'description': 'Point shorter than shaft (0.55–1.0)', 'threshold_min': 0.55, 'threshold_max': 1.0},
                {'code': '3', 'name': 'longer than shaft', 'description': 'Point as long as or longer than shaft (>1.0)', 'threshold_min': 1.0, 'threshold_max': None},
            ],
            'dependencies_json': [],
        },
        {
